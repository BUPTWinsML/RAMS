...
arm_cmsis_nn_status arm_convolve_s8(const cmsis_nn_context *ctx,
                                    ...
                                    const cmsis_nn_dims *output_dims,
                                    int8_t *output_data);
// arm_cmsis_nn_status arm_convolve_s8_m(const cmsis_nn_context_m *ctx,
//                                     const cmsis_nn_conv_params_m *conv_params,
//                                     const int32_t input_batches,
//                                     const uint16_t input_x,
//                                     const uint16_t input_y,
//                                     const uint16_t input_ch,
//                                     const uint16_t kernel_ch,
...
//                                     const int8_t *input_data,
//                                     int8_t *output_data);
void conv_1x1_s1_dw_3x3_conv_1x1(const cmsis_nn_context_m *ctx,
                              const int8_t *input_data,
                              int8_t *output_data,
...
void conv_1x1_s1_dw_7x7_conv_1x1(const cmsis_nn_context_m *ctx,
                              const int8_t *input_data,
                              int8_t *output_data,
                              const cmsis_nn_cdc_dims *dims,
                              const cmsis_nn_conv_params_simplified *conv1,
...
void conv_1x1_s1_dw_5x5_conv_1x1(const cmsis_nn_context_m *ctx,
                              const int8_t *input_data,
                              int8_t *output_data,
                              const cmsis_nn_cdc_dims *dims,
                              const cmsis_nn_conv_params_simplified *conv1,
...
// void conv_1x1_dw_3x3_s2_conv_1x1(const cmsis_nn_context_m *ctx,
//                                  const int8_t *input_data,
//                                  int8_t *output_data,
//                                  const cmsis_nn_dims_m *input_dims,
//                                  const cmsis_nn_conv_params_m *conv1_params,
//                                  const cmsis_nn_conv_params_m *conv2_params,
//                                  const cmsis_nn_conv_params_m *conv3_params);
// void conv_3x3_s2_dw_3x3_s1_conv_1x1(const cmsis_nn_context_m *ctx,
//                                  const int8_t *input_data,
//                                  int8_t *output_data,
//                                  const cmsis_nn_dims_m *input_dims,
//                                  const cmsis_nn_conv_params_m *conv1_params,
...
arm_cmsis_nn_status arm_depthwise_conv_wrapper_s8(const cmsis_nn_context *ctx,
                                                  ...
                                                  const cmsis_nn_dims *output_dims,
                                                  int8_t *output_data);
// arm_cmsis_nn_status arm_depthwise_conv_wrapper_s8_m(const cmsis_nn_context_m *ctx,
//                                                     const cmsis_nn_conv_params_m *dwconv_params,
//                                                     const cmsis_nn_dims_m *input_dims,
//                                                     const int8_t *input,
//                                                     int8_t *output);
...
arm_cmsis_nn_status arm_avgpool_s8(const cmsis_nn_context *ctx,
                                   ...
                                   const cmsis_nn_dims *output_dims,
                                   int8_t *output_data);
arm_cmsis_nn_status arm_avgpool_s8_m(void *buf,
