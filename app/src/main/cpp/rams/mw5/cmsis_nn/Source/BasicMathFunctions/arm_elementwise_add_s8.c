...

{
    static int cnt_0 = 0;
    if (cnt_0 == 6) {
        for (int i = 0; i < 9 * 9 * 32; i++) {
            // printf("%hhd, ", input_1_vect[i]);
        }
        for (int i = 0; i < 9 * 9 * 32; i++) {
            // printf("%hhd, ", input_2_vect[i]);
        }
        // printf("%d ", input_1_offset);
        // printf("%d ", input_1_mult);
        // printf("%d ", input_1_shift);
        // printf("%d ", input_2_offset);
        // printf("%d ", input_2_mult);
        // printf("%d ", input_2_shift);
        // printf("%d ", left_shift);
        // printf("%d ", out_offset);
        // printf("%d ", out_mult);
        // printf("%d ", out_shift);
        // printf("%d ", out_activation_min);
        // printf("%d ", out_activation_max);
        // printf("%d ", block_size);
    }
    cnt_0 ++;
