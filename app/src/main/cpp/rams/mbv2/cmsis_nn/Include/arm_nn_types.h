...
typedef struct
{
    void *im2col1;    /**< Pointer to a buffer needed for the optimization */
    void *im2col2;
    void *im2col3;
    void *mid_buf;
} cmsis_nn_context_m;
...
typedef struct
{
    ...
    int32_t h; /**< Height */
    int32_t w; /**< Width */
    int32_t in_c; /**< Input channels */
    int32_t dw_c;
    int32_t out_c;
    int32_t dw_pad_y; // dw_conv pad_y
} cmsis_nn_cdc_dims;
...
typedef struct
{
    ...
    int32_t w; /**< Width */
    int32_t in_c; /**< Input channels */
    int32_t dw_c; /**< DW channels */
    int32_t out_c; /**< Output channels */
    int32_t stride_w;
    int32_t stride_h;
    int32_t padding_w;
    int32_t padding_h;
...
typedef struct
{
    const int32_t *multiplier; /**< Multiplier values */
    const int32_t *shift;      /**< Shift values */
} cmsis_nn_per_channel_quant_params;

typedef struct
{
    cmsis_nn_per_channel_quant_params quant_param;
    const int32_t *bias;
    const int8_t *filter;
} cmsis_nn_conv_data_params;
...
typedef struct
{
    const int32_t min; /**< Min value used to clamp the result */
    const int32_t max; /**< Max value used to clamp the result */
} cmsis_nn_activation;
...
/** CMSIS-NN object for the simplified convolution layer parameters */
typedef struct
{
    int32_t input_offset;  /**< The negative of the zero value for the input tensor */
    int32_t output_offset; /**< The negative of the zero value for the output tensor */
    ...
    const int32_t *shift;
    cmsis_nn_activation activation;
} cmsis_nn_conv_params_simplified;
